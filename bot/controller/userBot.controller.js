      ...
      workoutProcess: {
        ...
        async stepOne(ctx) {
          try {
            ...
            console.log(`Ошибка в userBotController на шаге stepOne`, error);
        ...
        async stepTwo(ctx) {
          try {
            ...
            console.log(`Ошибка в userBotController на шаге stepTwo`, error);
            await ctx.reply(`Ошибка сервера`);
          } finally {
            await ctx.answerCallbackQuery();
          }
        ...
        async stepThree(ctx) {
          try {
            ...
            console.log(`Ошибка в userBotController на шаге stepThree`, error);
            await ctx.reply(`Ошибка сервера`);
          } finally {
            await ctx.answerCallbackQuery();
          }
        ...
        async stepFour(ctx) {
          try {
            ...
            console.log(`Ошибка в userBotController на шаге stepFour`, error);
            await ctx.reply(`Ошибка сервера`);
          }
        },
        ...
        async stepFive(ctx) {
          try {
            ...
            console.log(`Ошибка в userBotController на шаге stepFive`, error);
            await ctx.reply(`Ошибка сервера`);
          }
        },
